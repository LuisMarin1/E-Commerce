		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 registro">
				...
				<ul>
					...
					<li></li>
					<li><a href="#modalIngreso" data-toggle="modal">Crear una cuenta</a></li>
	...
	<div class="container">
		<div class="row" id="cabezote">
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="logotipo">
				<a href="#">
					<img src="http://localhost/E-commerce/backend/vistas/img/plantilla/logo.png" class="img-responsive">
				</a>
			</div>
			<!--=====================================
			...
			<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
				...
				BUSCADOR
				======================================-->
				<div class="input-group col-lg-8 col-md-8 col-xs-12" id="buscador">
		...
		<div class="col-xs-12 backColor" id="categorias">
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				...
				<hr>
				<ul>
					<li><a href="#" class="pixelCategorias">Lorem Ipsum</a></li>
					<li><a href="#" class="pixelCategorias">Lorem Ipsum</a></li>
					<li><a href="#" class="pixelCategorias">Lorem Ipsum</a></li>
				</ul>
			</div>
